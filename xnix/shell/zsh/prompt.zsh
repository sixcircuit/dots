...
SPACESHIP_TIME_TOO_LATE_YELLOW_COLOR=$gold
SPACESHIP_TIME_TOO_LATE_RED_COLOR=$red
...
SPACESHIP_ROOT="$PWD/spaceship-prompt"

source ./spaceship-prompt/spaceship.zsh
